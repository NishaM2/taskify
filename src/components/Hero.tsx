...
export default function Hero () {
    return (
        <div className="flex flex-col justify-center items-center text-center gap-2 lg:gap-3">
            <h1 className="text-2xl sm:text-2xl md:text-3xl lg:text-7xl font-Hero ">Smart Tools for Smarter <br/> Project Workflows</h1>
            <p className="text-[0.5rem] sm:text-[0.7rem] md:text-sm lg:text-md ">Streamline tasks, boost collaboration, and achieve goals effortlessly <br/>with your AI-driven project management assistant.</p>
